...
TrackIt is a full-stack Task and Habit Tracker application developed as a Semester 3 college mini-project. It features a Spring Boot backend with secure user authentication, task management, habit tracking, and analytics, paired with a frontend for user interaction. The `main` branch integrates both backend and frontend for a complete application.

## ✅ Project Overview

TrackIt helps users organize tasks and track habits through a user-friendly interface. The backend provides a secure REST API, while the frontend offers intuitive navigation for registration, login, and dashboard access.
...
The `main` branch combines the backend and frontend codebases:
...
The main branch merges backend and frontend branches. 
